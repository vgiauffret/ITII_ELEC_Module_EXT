...
void loop() {
  ...
  if (micros() - Balise_DernierEnvoi > 1000000 && counter == 0) {
    ...
    ///////////////// ENVOIE DE LA TRAME LoRa//////////////////////
    LoRa.beginPacket();
    LoRa.print("HelloYou ");
    LoRa.endPacket();   // envoie les datas
    ///////////////////////////////////////////////////////////////
  ...
  //////////////LECTURE DES MESSAGES STOCKE DANS LEBUFFER////////////////
  int packetSize = LoRa.parsePacket();   // onregarde si quelque chose est reçu
  if (packetSize) {   //// SI QUELQUE CHOSE EST PRESENT
    Serial.println("recu");
    cbk(packetSize);  //// ON LAFFICHE
  }
  /////////////////////////////////////////////////////////////////////
}
